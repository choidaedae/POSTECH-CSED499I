...
# train
train_set = {
        'root': '/root/daehyeonchoi/brats/brats-unet/data_process/dataset/BraTS2021/data/',  # 四个模态数据所在地址
        'out': '/root/daehyeonchoi/brats/brats-unet/data_process/dataset/BraTS2021/dataset/',  # 预处理输出地址
